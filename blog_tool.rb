...
class BlogTool
  ...
  def upload_file(img_path)
    ...
    request["user-agent"] = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36 Edg/111.0.1661.51"
    request["x-requested-with"] = "XMLHttpRequest"
    form_data = [['image', File.open(img_path)],['fileId', File.basename(img_path)],['initialPreview', '[]'],['initialPreviewConfig', '[]'],['initialPreviewThumbTags', '[]']]
